  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved filter as @filter" do
        ...
        post :create, {:filter => { "key" => "invalid value" }}, valid_session
        assigns(:filter).should be_a_new(Filter)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested filter" do
        ...
        Filter.any_instance.should_receive(:update_attributes).with({ "key" => "MyString" })
        put :update, {:id => filter.to_param, :filter => { "key" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the filter as @filter" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Filter.any_instance.stub(:save).and_return(false)
        put :update, {:id => filter.to_param, :filter => { "key" => "invalid value" }}, valid_session
        assigns(:filter).should eq(filter)
      end
