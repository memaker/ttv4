...
h2. Git
	...
	$ git fetch origin # to download all the remote branches and tags
	...
	Git on Ubuntu is 1.7.9.5, por lo que debo hacer $ git config --global push.default current.
	The new behaviour (check the version when updated to Ubuntu 14.04) is configured by $ git config --global push.default simple
